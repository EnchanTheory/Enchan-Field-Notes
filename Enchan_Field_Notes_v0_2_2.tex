...
% Title / Author
%===========================
\title{\textbf{Enchan Field Notes v0.2.2}\\[0.5em]
...
In this v0.2.2 update, we explicitly incorporate the role of \emph{rotation} in
determining the stability of spacetime structures. Drawing on the properties of
Kerr black holes in general relativity, we show how the dimensionless spin parameter
$a_*$ modifies the innermost stable circular orbit (ISCO) and the event horizon structure.
This provides a rigorous physical motivation for the axiomatic dependency of emergent
space $S$ on the rotational degree of freedom $\Omega$.
...
derived results. This v0.2.2 version is intended as a technical backbone and
...
\subsection*{Status of dimensional analysis in v0.2.2}

In this v0.2.2 version we do not yet fix the mass dimensions of $F$, $S$ and
...
v0.2.2 version we do not attempt to specify these microscopic symmetries. The
...
\subsection*{Limitations of the present v0.2.2 model}
...
an emergent functional of $S$. This is left open in v0.2.2.
...
v0.2.2 a set of sharp, unique observational signatures that would
