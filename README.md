...
## Overview
Enchan Field Notes is a collection of theoretical memoranda exploring the concept of **Emergent Spacetime** and **Geometric Dark Matter**.
It proposes a speculative framework where spacetime geometry emerges from microscopic fluctuations and rotational control.
...
- **Source code / build tooling (e.g. LaTeX build scripts, helper code):**
  [MIT License](LICENSE)

- **Textual content of “Enchan Field Notes” (the main .tex body, generated PDF, and any figures):**
