...
\end{equation}
The factor $c^2$ converts an energy-density scale into a stress scale, while
$\eta_S$ normalizes by the defect-strength parameter appearing in the logarithmic
profile of Eq.~(\ref{eq:S_log_profile}).
By construction, $P_{\rm def}$ has the dimensions of pressure
($[M][L]^{-1}[T]^{-2}$).
