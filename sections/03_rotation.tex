...
Within the Enchan v0.3.1 framework, rotation is not merely a source of angular momentum. It is the active process of "twisting" the local time-dilation field \EnchanS, creating a vortex that enhances the anchoring effect. This is the physical basis for the Enchan-001 device concept.
...
Why does Enchan v0.3.1 focus on rotation for the "Anchor" mechanism? Consider the difference between a nail and a screw.
